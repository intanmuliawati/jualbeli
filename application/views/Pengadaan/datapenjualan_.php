    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newpenjualanModal"> Upload Data Penjualan </a>
                        ...
                        <?php foreach ($penjualan as $pm) : ?>
                            <tr>
                                ...
                                <td style="text-align:center">
                                    ...
                                    <a href="<?= base_url() . 'datapenjualan_/hapuspenjualan/' . $pm['id_penjualan']; ?>" class="btn btn-danger btn-icon-split tombol-hapus">
                                        <span class="icon text-white-0">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newpenjualanModalLabel">Upload Data Penjualan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('/datapenjualan_/upload'); ?> " method="post" enctype="multipart/form-data">
            ...
            <!-- <form action="<?= base_url('datapenjualan_/add'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="preview" class="btn btn-primary"> Upload </button>
                </div>
            </form> -->
        </div>
    </div>
